...
const HaciendaSanCarlosProject = ({
  project,
  tempRating,
  rating,
  averageRating,
    ...
    >
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          <span className="px-3 py-1 text-xs sm:text-sm bg-[#4DB33D]/20 text-[#4DB33D] rounded-full flex items-center gap-1.5">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 1.2c5.077 0 9.2 4.123 9.2 9.2s-4.123 9.2-9.2 9.2-9.2-4.123-9.2-9.2 4.123-9.2 9.2-9.2zm0 1.2c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zm0 2.4c3.093 0 5.6 2.507 5.6 5.6s-2.507 5.6-5.6 5.6-5.6-2.507-5.6-5.6 2.507-5.6 5.6-5.6zm0 1.2c-2.485 0-4.4 1.915-4.4 4.4s1.915 4.4 4.4 4.4 4.4-1.915 4.4-4.4-1.915-4.4-4.4-4.4z"/>
            </svg>
            <span>MongoDB</span>
          </span>
        </div>
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          ...
          {/* Botón específico para Hacienda San Carlos */}
          <a
            href="https://github.com/nacho995/hacienda"
            target="_blank"
            rel="noopener noreferrer"
...
export default HaciendaSanCarlosProject; 