      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {project.title.includes("CodLet") ? (
            <>
              <TechTag color="#61DAFB" name="React">
                <img src="/react.png" alt="React icon" className="w-3.5 h-3.5" />
              </TechTag>
              <TechTag color="#38BDF8" name="TailwindCSS">
              ...
              <TechTag color="#68A063" name="Node.js">
            ...
            <>
              <TechTag color="#0070f3" name="Next.js">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Sistema de Rating (solo para CodLet) */}
        {project.title.includes("CodLet") && (
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="relative w-full max-w-7xl h-[90vh] bg-gradient-to-br from-white/[0.07] to-white/[0.03] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            ...
            {/* Contenido del Modal */}
            <div className="w-full h-[calc(90vh-4rem)] bg-white">
              <iframe
                id="preview-iframe"
                src={currentPreview}
