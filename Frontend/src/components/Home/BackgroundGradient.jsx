  ...
  return (
    <div className="fixed inset-0 -z-10 h-full w-full bg-[#13111C]">
      ...
      <div className={`absolute inset-0 bg-gradient-to-br ${
        theme === 'purple' 
          ? 'from-purple-800/30 via-[#13111C]/50 to-blue-900/30'
          : 'from-[#40A0E0]/30 via-[#13111C]/50 to-[#2980B9]/30'
      }`} />
      ...
      <div className="absolute right-[5%] sm:right-[10%] lg:right-[15%] top-[10%] sm:top-[15%] lg:top-[20%] select-none rotate-[-20deg] transform-gpu">
        <span className={`text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-transparent bg-clip-text ${
          theme === 'purple'
            ? 'bg-gradient-to-r from-purple-500 to-purple-300 drop-shadow-[0_0_15px_rgba(168,85,247,0.4)] [text-shadow:3px_3px_6px_rgba(168,85,247,0.4)]'
            : 'bg-gradient-to-r from-[#40A0E0] to-[#2980B9] drop-shadow-[0_0_15px_rgba(64,160,224,0.4)] [text-shadow:3px_3px_6px_rgba(64,160,224,0.4)]'
        } tracking-wider`}>
          React
        </span>
      </div>
      ...
      <div className="absolute right-[35%] sm:right-[30%] lg:right-[25%] top-[25%] sm:top-[30%] lg:top-[35%] select-none rotate-[10deg] transform-gpu">
        <span className={`text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-mono text-transparent bg-clip-text ${
          theme === 'purple'
            ? 'bg-gradient-to-r from-purple-400 to-blue-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.4)] [text-shadow:3px_3px_6px_rgba(168,85,247,0.4)]'
            : 'bg-gradient-to-r from-[#40A0E0] to-[#2980B9] drop-shadow-[0_0_15px_rgba(64,160,224,0.4)] [text-shadow:3px_3px_6px_rgba(64,160,224,0.4)]'
        }`}>
          {'</>'}
        </span>
      ...
      <div className={`absolute top-0 right-0 w-[300px] h-[300px] md:w-[450px] md:h-[450px] lg:w-[600px] lg:h-[600px] ${
        theme === 'purple' 
          ? 'bg-purple-600/15'
          : 'bg-[#40A0E0]/15'
      } rounded-full blur-[80px] md:blur-[100px] lg:blur-[120px] animate-pulse-slow`} />
