...
const translations = {
  es: {
    ...
    'lorekeeper.title': 'Lorekeeper — Story Bible Studio',
    'lorekeeper.description': 'Estudio de worldbuilding para crear mundos, personajes, localizaciones y facciones para libros, juegos y series. Microservicios: .NET 8 (Auth + World Services), React + Vite frontend, FastAPI + Groq AI para generación de contenido, YARP API Gateway, PostgreSQL. Desplegado en Fly.io.',
    'vibelink.title': 'VibeLink — Dating App por Gustos',
    'vibelink.description': 'App de citas basada en gustos compartidos en películas, series y videojuegos. Los usuarios hacen swipe en contenido y entre sí. React + TypeScript frontend, FastAPI backend con SQLAlchemy async, integración con TMDB e IGDB APIs, pagos con Stripe, chat en tiempo real. PostgreSQL + Docker.',
    'jobboardai.title': 'JobBoard AI — Portal de Empleo Inteligente',
    'jobboardai.description': 'Portal de empleo con IA que agrega ofertas de múltiples fuentes (LinkedIn, InfoJobs, Indeed, Remotive) y proporciona recomendaciones inteligentes por chat. Angular 21 + Java 21 Spring Boot con arquitectura hexagonal + FastAPI con Groq AI. 300+ ofertas de toda Europa.',
  ...
  en: {
    ...
    'lorekeeper.title': 'Lorekeeper — Story Bible Studio',
    'lorekeeper.description': 'Worldbuilding studio for creating worlds, characters, locations, and factions for books, games, and series. Microservices: .NET 8 (Auth + World Services), React + Vite frontend, FastAPI + Groq AI for content generation, YARP API Gateway, PostgreSQL. Deployed on Fly.io.',
    'vibelink.title': 'VibeLink — Interest-Based Dating App',
    'vibelink.description': 'Dating app where matching is based on shared preferences in movies, TV shows, and video games. Users swipe on content and on each other. React + TypeScript frontend, FastAPI backend with async SQLAlchemy, TMDB and IGDB API integration, Stripe payments, real-time chat. PostgreSQL + Docker.',
    'jobboardai.title': 'JobBoard AI — Smart Job Portal',
    'jobboardai.description': 'AI-powered job board aggregating listings from multiple sources (LinkedIn, InfoJobs, Indeed, Remotive) with intelligent chat-based recommendations. Angular 21 + Java 21 Spring Boot with hexagonal architecture + FastAPI with Groq AI. 300+ jobs across Europe.',
